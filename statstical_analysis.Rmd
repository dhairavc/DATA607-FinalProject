...
We know that multiple regression models are written in the form below, where $\beta_i$ represents the predictor variables. 
...
6. With an R-squared of ~75% we found that unemployment is indeed a good predictor of crime but the model assumptions may be valid.  
