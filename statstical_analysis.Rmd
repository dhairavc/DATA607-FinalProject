...
This project provided us with the opportunity of showcasing many of the skills we have learned throughout this course and of applying them to an investigation into datasets of our choosing. We narrowed our scope to a few datasets containing information on social economic information, namely unemployment and crime data in NYC. Specifically we would like to explore the impact of unemployment on crime within the New York City. The overarching question we want to hypothesize on would be

\[H0: Unemployment \ does \ not \ impact \ crime\ (R^2 = 0) \]
\[HA: Unemployment \ does \ impact \ crime\ (R^2 > 0) \]


We hope that this investigation and other explotory alongside will provide use information that could be used to formulate policy proposals. We used the following process for each dataset:	
