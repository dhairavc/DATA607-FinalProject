...
Perhaps we can comment on effective crime measures by looking at the least common crimes.

```{r message=FALSE, warning=FALSE}

ggplot(grouped_offenses %>% top_n(-25), aes(x = reorder(ofns_desc, -count, FUN = sum), y = count)) + 
