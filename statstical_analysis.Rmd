...
m_sex <- lm(crimes ~ susp_sex, data = filtered)
summary(m_sex) # no significance
```
...
It can be seen that being **Black** is significantly associated with an average increase of 1454 in crime compared to other races with **R-squared ~ 0.34**.
