...
treemap(murder_counts, #Your data frame object
        ...
        title="Crime distribution committed by different races", #Customize your title
        fontsize.title = 11 #Change the font size of the title
        ) 
```
