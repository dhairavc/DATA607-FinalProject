...
```{r density plot for age, message=FALSE, warning=FALSE, echo=FALSE}
...
As pointed by the simple linear regression, unemployment has an **R-squared  ~0.8**. This makes it a better predictor of the number of crimes. 
...
```{r exploratory analysis, warning=FALSE, message=FALSE, echo=FALSE}
